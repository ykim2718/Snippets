// var board = require('../models/board');  // Mongo DB
var board = require('../models/board_mysql');  // SQL DB

// 게시물 목록 조회
module.exports.list = function(req, res) {
	board.list(function(result){
	   res.render('board/list', {title: "게시물 등록", list: result});
	});
};
...
// 게시물 등록, post 방식으로 넘어오는 data는 body에서 꺼내면 됨!!!
