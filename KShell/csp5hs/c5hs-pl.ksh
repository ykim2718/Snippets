...
%gBeg_
 ...
 _defn "WIDTH"    "25"
 .glob 
       gtxt txt="XXX_NAME,PMOSFET,W=WIDTHum" t.width=10 t.height=20
...
! (c)shik : core-03
 .plot
       ...
       slct yno=(*) xno=1 XB ylb=60 yub=110 range=XXX_RANGE
...
! (c)shik : core-05
 .plot 
       ...
       slct yno=(*) xno=1 XB ylb=100 yub=300 range=XXX_RANGE
       +    lg.type=XXX_LGTYPE lg.size=1 FILL
