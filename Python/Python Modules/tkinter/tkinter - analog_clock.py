"""
y, 2020.1.15 - 16
tkinter - analog_clock.py

Reference
---------
[1] https://github.com/yumaikas/pyAnalogClock/blob/master/src/Clock.py
[2] https://stackoverflow.com/questions/38612509/how-to-run-a-python-script-without-windows-console-appearing

Example
-------
pythonw.exe "tkinter - analog_clock.py"  # [2]
"""
...
from tkinter import Tk, Canvas  # Tkinter >> tkinter, by Y
...
class clockHands():
    ...
    def updateClock(self, canvas):
        ...
        # ~2020.2.25 - 26
        if time.second % 59 == 0:
            # print(time, time.minute, time.second)
            import subprocess
            subprocess.run([
                'python.exe',
                r"d:\HA\yStudy on code - Python\Python - Snippets\yPython on MS-Windows\yPython on WinAPI"
                r"\how to generate key board event.py"
            ], shell=True)  # shell=True hides console; don't know why, 2020.2.25, y
