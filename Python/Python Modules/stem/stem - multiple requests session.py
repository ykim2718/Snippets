...
class TorRequestsSession(SingletonClass):
    ...
    def __init__(self, session_count=5, max_session_count=100, skip_my_ip=True):
        ...
        self.my_addr = self.get_public_ip_address_with_session()  # 118.220.52.143
    ...
    def generate_sessions(self, session_count=5, max_session_count=100, skip_my_ip=True):
        ...
        def _get_session_and_ip(port=9050) -> typing.Tuple[str, str]:
            ...
            ip_address = self.get_public_ip_address_with_session(session)
    ...
    def get_public_ip_address_with_session(self, session=None) -> str:
        """
        y,  2023.12.21 - 22
            2024.1.11
        """
