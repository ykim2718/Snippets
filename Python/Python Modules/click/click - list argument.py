...
@click.option('--option1', cls=PythonLiteralOption, default='[1]')
@click.option('--option2', cls=PythonLiteralOption, default='[1, 2]')
@click.option('--option3', cls=PythonLiteralOption, default='[1, 2, 3]')
