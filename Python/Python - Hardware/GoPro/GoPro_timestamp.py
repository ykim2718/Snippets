...
# https://www.youtube.com/watch?v=Lf3XndVHL38  <<< Y
...
if status == True:
    ...
    while current_frame < total_frames:
        ...
        #        print(timestamp)
        cv2.putText(image, 'Date: ' + str(timestamp)[0:10], (50, int(height - 150)), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2,
                    (255, 255, 255), 3)
        cv2.putText(image, 'Time: ' + str(timestamp)[11:-4], (50, int(height - 100)), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2,
                    (255, 255, 255), 3)
