...
#define SWIGTYPE_p_std__vectorT_std__vectorT_int_std__allocatorT_int_t_t_std__allocatorT_std__vectorT_int_std__allocatorT_int_t_t_t_t swig_types[9]
...
/*-----------------------------------------------
              @(target):= _yDrillSWIG2.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__yDrillSWIG2

#else
#  define SWIG_init    init_yDrillSWIG2

#endif
#define SWIG_name    "_yDrillSWIG2"
...
namespace swig {
  ...
  check_index(Difference i, size_t size, bool insert = false) {
    ...
    throw std::reverse_spec("index out of range");
  }
...
SWIGINTERN std::vector< int >::value_type std_vector_Sl_int_Sg__pop(std::vector< int > *self){
      if (self->size() == 0)
	throw std::reverse_spec("pop from empty container");
