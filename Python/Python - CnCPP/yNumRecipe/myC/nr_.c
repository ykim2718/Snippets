...
void pzextr_(int iest, double xest, double yest[], double yz[], double dy[], int nv)
{
	int k1,j;
	...
	void (*derivs)(double, double [], double []))
{
	...
	void simpr(double y[], double dydx[], double dfdx[], double **dfdy,
		...
		void (*derivs)(double, double [], double []));
	void pzextr_(int iest, double xest, double yest[], double yz[], double dy[],
		int nv);
	int i,iq,k,kk,km;
