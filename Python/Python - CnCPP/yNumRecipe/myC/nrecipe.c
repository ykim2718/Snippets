...
/*                       creating date : 43240103-43250115                    */
/* 4332 0303,____,____,____,____,____,____,____,____,____,____,____,____,____ */
/* 4334 0604,____,____,____,____,____,____,____,____,____,____,____,____,____ */
/* 4336 0210-0225,0318,0503,0611,0806,0820,0901-0902,0929-0930,1207-1209,____ */
/* 4337 0101-0103,0613,____,____,____,____,____,____,____,____,____,____,____ */
/******************************************************************************/
   ...
   double d;
{
   ...
   return pow(10.0,d);
#else
#error Compiler type should be declared.
#endif
}
   ...
   VECTOR *pXVec,*pYVec,*pZVec;
{
   ...
   if (k==nL) {
      ...
      VDestroy(vY,nL,nH);
      VDestroy(vZ,nL,nH);
      *pXVec=*pYVec=*pZVec=(VECTOR)(*pnL=*pnH=0);
      return 0;
   }
   VDestroy(*pXVec,nL,nH);
   VDestroy(*pYVec,nL,nH);
