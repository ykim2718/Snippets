...
/*-----------------------------------------------
              @(target):= _yDrillSWIG.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__yDrillSWIG

#else
#  define SWIG_init    init_yDrillSWIG

#endif
#define SWIG_name    "_yDrillSWIG"
...
SWIGINTERN PyObject *_wrap_check_array1d(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  int *arg3 = (int *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:check_array1d",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "check_array1d" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "check_array1d" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "check_array1d" "', argument " "3"" of type '" "int *""'"); 
  }
  arg3 = (int *)(argp3);
  result = (int)check_array1d(arg1,arg2,arg3);
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_check_array2d_w_numpy(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:check_array2d_w_numpy",&obj0)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
    array1 = obj_to_array_contiguous_allow_conversion(obj0, NPY_INT,
      &is_new_object1);
  ...
  result = (int)check_array2d_w_numpy(arg1,arg2,arg3);
  resultobj = SWIG_From_int((int)(result));
  {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"check_array1d", _wrap_check_array1d, METH_VARARGS, NULL},
	 { (char *)"check_array2d_w_numpy", _wrap_check_array2d_w_numpy, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
