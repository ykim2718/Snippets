========================================================================
		ActiveX Control DLL : GARGAMELPATTERNFORMATRIX
========================================================================

ControlWizard has created this project for your GARGAMELPATTERNFORMATRIX ActiveX Control
...
GargamelPatternForMatrix.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
GargamelPatternForMatrix control:

GargamelPatternForMatrixCtl.h
	This file contains the declaration of the CGargamelPatternForMatrixCtrl C++ class.

GargamelPatternForMatrixCtl.cpp
	This file contains the implementation of the CGargamelPatternForMatrixCtrl C++ class.

GargamelPatternForMatrixPpg.h
	This file contains the declaration of the CGargamelPatternForMatrixPropPage C++ class.

GargamelPatternForMatrixPpg.cpp
	This file contains the implementation of the CGargamelPatternForMatrixPropPage C++ class.

GargamelPatternForMatrixCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGargamelPatternForMatrixCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GargamelPatternForMatrix.rc.
