========================================================================
		ActiveX Control DLL : GRAPHERRENOVATORDIALOG
========================================================================

ControlWizard has created this project for your GRAPHERRENOVATORDIALOG ActiveX Control
...
GrapherRenovatorDialog.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
GrapherRenovatorDialog control:

GrapherRenovatorDialogCtl.h
	This file contains the declaration of the CGrapherRenovatorDialogCtrl C++ class.

GrapherRenovatorDialogCtl.cpp
	This file contains the implementation of the CGrapherRenovatorDialogCtrl C++ class.

GrapherRenovatorDialogPpg.h
	This file contains the declaration of the CGrapherRenovatorDialogPropPage C++ class.

GrapherRenovatorDialogPpg.cpp
	This file contains the implementation of the CGrapherRenovatorDialogPropPage C++ class.

GrapherRenovatorDialogCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGrapherRenovatorDialogCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GrapherRenovatorDialog.rc.
