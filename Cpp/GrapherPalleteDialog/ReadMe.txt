========================================================================
		ActiveX Control DLL : GRAPHERPALLETEDIALOG
========================================================================

ControlWizard has created this project for your GRAPHERPALLETEDIALOG ActiveX Control
...
GrapherPalleteDialog.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
GrapherPalleteDialog control:

GrapherPalleteDialogCtl.h
	This file contains the declaration of the CGrapherPalleteDialogCtrl C++ class.

GrapherPalleteDialogCtl.cpp
	This file contains the implementation of the CGrapherPalleteDialogCtrl C++ class.

GrapherPalleteDialogPpg.h
	This file contains the declaration of the CGrapherPalleteDialogPropPage C++ class.

GrapherPalleteDialogPpg.cpp
	This file contains the implementation of the CGrapherPalleteDialogPropPage C++ class.

GrapherPalleteDialogCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGrapherPalleteDialogCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GrapherPalleteDialog.rc.
