...
# _defn "NRLH_BV"  "nrl=21 nrh=25"
# _defn "NRLH_IB"  "nrl=26 nrh=30"
#
#! copyLeft_shik 02
# .plot
#       attr moment ylin
#       data name="_PATH_/csp7l-ntr._FILE_.plt" switch
...
#       data name="_PATH_/csp7l-ntr._FILE_.plt"
...
#       attr omtx moment ylin
#       data name="_PATH_/csp7l-ntr._FILE_.plt"
#       slct yno=(*) xno=1 XB ylb=200 yub=600 range=_RANGE_ NRLH_ID
#       +    type=_SYMBOL_ legn.size=1 FILL
...
#       attr omtx moment ylin
#       data name="_PATH_/csp7l-ntr._FILE_.plt"
#       slct yno=(*) xno=1 XB ylb=0 yub=12 range=_BVRANGE_ NRLH_BV
#       +    type=_SYMBOL_ legn.size=1 FILL
#       ufun seqn=0 fn=6 pgm="z=abs(z)"
...
#       attr back omtx moment
#       data name="_PATH_/csp7l-ntr._FILE_.plt"
#       slct yno=(*) xno=1 range=_BVRANGE_ NRLH_BV
#       +    type=_SYMBOL_ legn.size=1 FILL
#       ufun seqn=0 fn=6 pgm="z=abs(z)"
#
#! copyLeft_shik 12
...
#       attr omtx moment ylog
#       data name="_PATH_/csp7l-ntr._FILE_.plt"
#       slct yno=(*) xno=1 XB ylb=1e-1 yub=1e1 range=_RANGE_ NRLH_IB
#       +    type=_SYMBOL_ legn.size=1 FILL
#       ufun seqn=0 fn=6 pgm="z=abs(z)" ncl=2 nch=100
#       axis type=y,0 label=t lb.f="%g" TEXT4 LOGA
#       +    type=y,1 loc=upper
...
#       attr back omtx moment
#       data name="_PATH_/csp7l-ntr._FILE_.plt"
#       slct yno=(*) xno=1 range=_RANGE_ NRLH_IB
#       +    type=_SYMBOL_ legn.size=1 FILL
#       ufun seqn=0 fn=6 pgm="z=abs(z)" ncl=2 nch=100
#
#! copyLeft_shik 14
